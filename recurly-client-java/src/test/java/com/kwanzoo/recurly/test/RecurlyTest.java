    ...
    extends TestCase
{
    ...
    /*
     * private String getRandNum(final int n){ return RandomStringUtils.randomNumeric(n); }
     */
        ...
        throws Exception
    {
        ...
        final String verificationValue = "1234";
        ...
        String planCode = "test"; // one of the plans defined in your recurly account
        Integer quantity = 1;
        ...
        planCode = "test"; // a plan with lesser features/rate than testplan1
        quantity = 2;
        ...
        planCode = "test"; // a plan with better features/rate than testplan1
        quantity = 3;
